...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <button onclick="window.location.href='ManageBooks.php'">
      <i class="fas fa-book-open"></i><span>Manage Books</span>
    </button>
    
    <button onclick="window.location.href='ViewArchived.php'">
      <i class="fas fa-calendar-alt"></i><span>Archived Books</span>
    </button>
  
    <div style="margin-top: auto; width: 100%; display: flex; flex-direction: column; align-items: center; padding-bottom: 20px;">
        
        <button class="active" onclick="window.location.href='profile.php'">
            <i class="fas fa-user-circle"></i><span>My Profile</span>
        </button>
        
        <button onclick="window.location.href='logout.php'" style="color: #fda4af;">
    ...
    <div class="profile-container">
        ...
        <div class="profile-card">
            <div class="profile-header">
                ...
                <p style="margin:5px 0 0; color: #d97706;">Librarian</p>
            </div>
            ...
            <div class="info-group">
                ...
                <div class="info-value">Librarian-<?= str_pad($user['User_ID'], 4, '0', STR_PAD_LEFT) ?></div>
            </div>
