...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <a href="ManageBorrowReservation.php"><i class="fas fa-book-open"></i><span>Borrow & Reservation</span></a>
    <a href="ManagePenalty.php"><i class="fas fa-calendar-alt"></i><span>Penalty & Payment</span></a>
    ...
    <div class="profile-container">
        ...
        <div class="profile-card">
            <div class="profile-header">
                ...
                <p style="margin:5px 0 0; color: #d97706;">Staff</p>
            </div>
            ...
            <div class="info-group">
                ...
                <div class="info-value">Staff-<?= str_pad($user['User_ID'], 4, '0', STR_PAD_LEFT) ?></div>
            </div>
